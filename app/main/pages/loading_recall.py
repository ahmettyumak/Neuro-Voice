...
from ai_model_recall import analyze_recall_for_streamlit

st.set_page_config(page_title="Analyzing Recall...", page_icon="📖", layout="centered")
...
st.markdown("""
    ...
    <div class="title-container"><h1 class="gradient-text">NeuroVoice AI</h1><p class="subtitle">Story Recall (Memory) Module</p></div>
...
update_status("📡 Extracting Memory Biomarkers...", 15)
...
update_status("🧬 Analyzing Memory & Narrative Loss...", 45)
results = analyze_recall_for_streamlit(tmp_path)

update_status("⚖️ Calculating Memory Deficit Risk...", 85)
time.sleep(0.5)
os.remove(tmp_path)

# Sonuçları 'analysis_results_recall' içine kaydediyoruz
st.session_state.analysis_results_recall = results
st.switch_page("pages/results_recall.py")