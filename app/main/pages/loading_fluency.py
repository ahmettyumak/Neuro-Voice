...
from ai_model_fluency import analyze_fluency_for_streamlit

st.set_page_config(page_title="Analyzing Fluency...", page_icon="⏳", layout="centered")
...
st.markdown("""
    ...
    <div class="title-container"><h1 class="gradient-text">NeuroVoice AI</h1><p class="subtitle">Verbal Fluency Module</p></div>
    <div class="pulse-box"><div class="ring"></div><div class="ring"></div><div class="ring"></div><div class="core-icon">⏱️</div></div>
...
update_status("📡 Extracting Fluency Biomarkers...", 15)
...
update_status("🧬 Running Isolation Forest Models...", 45)
results = analyze_fluency_for_streamlit(tmp_path)

update_status("⚖️ Calculating Anomaly Probabilities...", 85)
time.sleep(0.5)
os.remove(tmp_path)

# Sonuçları 'analysis_results_fluency' içine kaydediyoruz
st.session_state.analysis_results_fluency = results
st.switch_page("pages/results_fluency.py")