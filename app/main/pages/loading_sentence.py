...
from ai_model_sentence import analyze_sentence_for_streamlit

st.set_page_config(page_title="Analyzing Sentence...", page_icon="🧩", layout="centered")
...
st.markdown("""
    ...
    <div class="title-container"><h1 class="gradient-text">NeuroVoice AI</h1><p class="subtitle">Sentence Construction (Syntax) Module</p></div>
...
update_status("📡 Extracting Syntactic Biomarkers...", 15)
...
update_status("🧬 Analyzing Grammatical Structures...", 45)
results = analyze_sentence_for_streamlit(tmp_path)

update_status("⚖️ Calculating Syntactic Deficit Risk...", 85)
time.sleep(0.5)
os.remove(tmp_path)

# Sonuçları 'analysis_results_sentence' içine kaydediyoruz
st.session_state.analysis_results_sentence = results
st.switch_page("pages/results_sentence.py")