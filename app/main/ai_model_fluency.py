...
# --- AYARLAR ---
ONNX_MODEL_FILE = "app/main/model_fluency_isoforest.onnx"
SCALER_FILE = "app/main/model_fluency_scaler.pkl"
COLUMNS_FILE = "app/main/model_fluency_columns.pkl"
SAMPLE_RATE = 16000
...
def isolate_patient_audio(segments_list, y, sr):
    ...
    for seg in segments_list:
        ...
        doc_phrases = ["minute", "letter", "start", "begin", "ready", "ahead", "change", "directions", "stop", "name for me", "tell me", "time"]
        ...
        if noun_ratio > 0.35: patient_segments.append(seg)
        elif doc_score > 0 and len(words) < 25: doctor_segments.append(seg)
        elif len(words) > 40: patient_segments.append(seg)
        elif doc_score >= 2: doctor_segments.append(seg)
        else: patient_segments.append(seg)
