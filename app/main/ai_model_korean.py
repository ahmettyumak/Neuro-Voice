...
ONNX_MODEL_FILE = "app/main/model_KOREAN.onnx"
SCALER_FILE = "app/main/model_KOREAN_scaler.pkl"
COLUMNS_FILE = "app/main/model_KOREAN_columns.pkl"
SAMPLE_RATE = 16000
...
def load_ai_models():
    ...
    # 1. WHISPER MODELİ (VRAM KORUMASI EKLENDİ - "medium" MODEL)
    ...
    # 2. KORECE NLP MODELİ (EKSİK OLAN KISIM BURASIYDI!)
...
def extract_korean_features(file_path):
    ...
    patient_segments, patient_y, patient_text, doctor_text, pat_dur, doc_dur = isolate_patient_audio_nlp(list(segments), y, sr)
    ...
    features["Oran_Sessizlik"] = (patient_total_duration - speech_duration) / patient_total_duration if patient_total_duration > 0 else 0
