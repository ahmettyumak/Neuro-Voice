...
ONNX_MODEL_FILE = "app/main/alzheimer_es_xgboost_model.onnx"
SCALER_FILE = "app/main/alzheimer_es_scaler.pkl"
COLUMNS_FILE = "app/main/alzheimer_es_columns.pkl"
SAMPLE_RATE = 16000
MAX_AUDIO_DURATION = 600

SEARCH_TERMS = {
    "Dolgu_Kelimeleri": ["eh", "este", "pues", "bueno", "mhm", "ah", "mmm", "o sea", "sabes", "digamos", "vale", "a ver", "digo", "tipo", "claro", "nada"],
    "Bos_Kelimeler": ["cosa", "cosas", "algo", "eso", "esto", "aquello", "asunto", "tema", "cuestión", "chisme", "cacharro", "trasto", "aparato"],
}
...
def extract_test_features(file_path):
    ...
    # Şimdilik güvenlik kapısı toleranslı
