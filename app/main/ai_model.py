...
# ⚙️ AYARLAR
# =============================================================================
ONNX_MODEL_FILE = "app/main/alzheimer_real_xgboost.onnx"
SCALER_FILE = "app/main/alzheimer_real_scaler.pkl"
PCA_FILE = "app/main/alzheimer_real_pca.pkl"
COLUMNS_FILE = "app/main/alzheimer_real_columns.pkl"
...
def load_ai_models():
    ...
    if bert_model is None: bert_model = SentenceTransformer('all-MiniLM-L6-v2')
...
def analyze_for_streamlit(audio_path):
    ...
    features, rapor_detaylari = extract_test_features(audio_path)

    if features is None:
        return {"status": "error", "message": rapor_detaylari}
