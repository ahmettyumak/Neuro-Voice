# app/main/style/mandarin_css.py

def mandarin_class_css(bg, text, card_bg, border, input_bg, browse_bg, browse_text, layout_border, upload_hint):
    return f"""
    <style>
        ...
        /* 2. GENEL TEMA VE YAZILAR (MANDARİN/ÇİNCE ÖZEL FONTLAR EKLENDİ 🇨🇳) */
        .stApp {{ background-color: {bg} !important; font-family: 'Inter', 'Noto Sans SC', 'Microsoft YaHei', 'PingFang SC', sans-serif; transition: background-color 0.4s ease; }}
        ...
        /* 🎯 "Drag and drop..." ve "Limit 200MB..." YAZILARINI KÖKÜNDEN YOK ET VE YENİSİNİ EKLE */
