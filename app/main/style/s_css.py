# app/main/style/spanish_css.py

def spanish_class_css(bg, text, card_bg, border, input_bg, browse_bg, browse_text, layout_border, upload_hint):
    return f"""
    <style>
        ...
        /* 2. GENEL TEMA VE YAZILAR (İSPANYOLCA/LATİN ÖZEL FONTLAR EKLENDİ 🇪🇸) */
        .stApp {{ background-color: {bg} !important; font-family: 'Inter', 'Roboto', 'Open Sans', sans-serif; transition: background-color 0.4s ease; }}
